...
const TextBildTwo = ({ translation, handleStepTwoSelectChange, data }) => {
      ...
      <Col md={12} lg={12} key={box + id}>
        ...
        >
          <div className="img-in">
            <img src={box.icon} alt="Info" />
          </div>
          <div className="info-about">{box.name && <h5>{box.name}</h5>}</div>
  ...
  return (
    <Modal
      className="text-image-variant-modal text-bild-two-modal"
      show={showInfo.isVisible}
      onHide={() => {
        return false;
      }}
    >
      <div className="info-modal-wrapper text-image-modal br-overlays">
        <div className="container-md">
          ...
          <div className="info-box">
            ...
            <div className="info-desc">
              {/* {data.description && <p>test {data.description}</p>} */}
              {data.description && (
                <p
                  dangerouslySetInnerHTML={{
